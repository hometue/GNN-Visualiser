...
import { Button, Card, CardHeader, Dialog, DialogContent, MenuItem, Select, TextField } from "@mui/material";
	...
	return (
		<>
			<Card variant="outlined" style={{display: "flex", flexDirection: "column", height: '100%'}}>
				<div style={{flex: "2"}}>Click on a node to display the messages sent by nodes and the node embeddings generated by the layer. Double click on a selected node to edit the weight and bias.</div>
				<div style={{flex: "3"}} ref={graphRef}></div>
			</Card>
