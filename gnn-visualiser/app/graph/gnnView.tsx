	...
	return (
		<>
			<div style={{display: "flex", flexDirection:"column", width: '100%', height: '100%'}}>
				<div style={{flex: 1}}>Click on a node to display the messages sent by nodes and the node embeddings generated by the layer. Double click on a selected node to edit the weight and bias.</div>
				<div style={{flex: 1}} ref={graphRef}></div>
			</div>
